...
>
    <div class="w-full h-16 bg-gray-50 border-b border-gray-100">
        <div class="flex justify-between items-center mx-auto space-x-4 max-w-7xl h-full p-gutter-x">
            ...
            <livewire:pinger.pinger-create/>
        </div>
    </div>

    <x-pinger-created-banner
        message="{{ __('Your pinger was successfully created!') }}"
        class="rounded-none"
    />
    <x-pinger-updated-banner
        message="{{ __('Your pinger was successfully updated!') }}"
        class="rounded-none"
    />
    ...
    <div class="flex flex-1 w-full">
        ...
        @if($targets->isNotEmpty())
            ...
            <div class="flex flex-1 mx-auto max-w-7xl lg:p-gutter-x lg:divide-x lg:divide-gray-100 lg:divide-solid">
                ...
                <div class="flex flex-col flex-1 bg-white border-l-0 border-gray-100 lg:z-10 lg:border-l shadow-right">
                    @include('livewire.pinger.partials.pinger-list')
                </div>
                ...
                >
                    ...
                    >
                        ...
                        @include('livewire.pinger.partials.pinger-details', [
                            'target' => $this->target
                        ])
                    </div>
                </div>
        ...
        @else
            @include('livewire.pinger.partials.no-pingers')
        @endif
    </div>
</div>
